...
import { AlertCircle, LayoutGrid, MapPin } from 'lucide-react';
import { TenantProvider, useTenant } from '@/lib/tenant';

const TABS = [
  { href: '/admin/tables', label: 'Mesas', icon: LayoutGrid, exact: true },
  { href: '/admin/tables/areas', label: 'Áreas', icon: MapPin, exact: false },
];

function TablesShell({ children }: { children: React.ReactNode }) {
